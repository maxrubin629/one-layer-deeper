"""Tied GELU recurrence with persistent learned modulus context."""
...
class ContextualGELUTransition(nn.Module):
    """Receives only recurrent state and learned N-field context."""
    ...
    def forward(self, state: Tensor, context: Tensor) -> Tensor:
        ...
        update = self.down(F.gelu(self.up(features)))
